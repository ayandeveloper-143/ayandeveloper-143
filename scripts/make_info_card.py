...
# ===========================================================================
HOST = "ayandeveloper-143"   # shown as  you@github  in the header

ROWS = [
    ("host",),
    ("kv", "Now", "Software Engineer"),
    ("kv", "Prev", "Full Stack Developer"),
    ("kv", "Also", "Open Source Contributor"),
    ("kv", "Edu", "Computer Science"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Frontend", "React, Next.js, TypeScript, CSS"),
    ("kv", "Backend", "Node.js, Express, Python, SQL"),
    ("kv", "Tools", "Git, Docker, VS Code"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Building interactive web experiences"),
    ("bul", "Designed animated profile readme automation"),
]
